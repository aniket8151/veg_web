    ...
    <div className='footer'>
      <div className='footerin1'>
        <div className='f1'>
          ...
          <p>Vege Island is a leading online grocery store in the INDIA. We are committed to providing the best quality products at the best prices.</p>
      ...
      <div className='footerin2'>
        <h3>© Copyright 2023 Vege Island, Inc.  All rights reserved</h3>
